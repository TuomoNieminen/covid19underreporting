...
\author{Tuomo A. Nieminen$^\ast$, Kari Auranen, Sangita Kulathinal, \\
Tommi Härkänen, Merit Melin, Arto Palmu, Jukka Jokinen}

\textit{Finnish Institute for Health and Welfare,
University of Turku,
University of Helsinki}
\\[2pt]

% \author[1,2]{Tuomo A. Nieminen$^\ast$}
% \author[1,3]{Kari Auranen}
% \author[2, 1]{Sangita Kulathinal}
% \author[1,2]{Tommi Härkänen}
% \author[1]{Merit Melin}
% \author[1]{Arto Palmu}
% \author[1,2]{Jukka Jokinen}

% \address[1]{\orgname{Finnish Institute for Health and Welfare}, \orgaddress{\country{Finland}}}
% \address[2]{ \orgname{University of Helsinki}, \orgaddress{\country{Finland}}}
% \address[3]{ \orgname{University of Turku}, \orgaddress{\country{Finland}}}


% E-mail address for correspondence
{\email{tuomo.nieminen@thl.fi, tuomo.a.nieminen@gmail.com}}

% Running headers of paper:
\markboth%
% First field is the short list of authors
{Tuomo A. Nieminen and others}
% Second field is the short title of the paper
{Underreporting SARS-CoV-2 infections}
...
We utilised the No-U-Turn Sampler algorithm for sampling, which is an efficient Markov Chain Monte Carlo algorithm (\cite{homan2014}). We used STAN and the R package Rstan to carry out the sampling and monitored convergence via the Rhat statistic (\cite{carpenter2017}, \cite{R2021} ,\cite{standev2020rstan}). The STAN model code and an R code example are available on \url{https://github.com/TuomoNieminen/covid19underreporting}.
...
We report no conflict of interests related to the current work. 

Finnish Institute for Health and Welfare (THL) conducts Public-Private Partnership with vaccine manufacturers and has received research funding from Sanofi Inc., Pfizer Inc., and GlaxoSmithKline Biologicals SA for studies not related to COVID-19. NT, MM, AAP and JJ have been investigators in these studies, but they have received no personal remuneration.


\section{Acknowledgments}

We thankfully acknowledge the fluent collaboration with the Digital and Population Data Services Agency DVV for access to the Finnish Population Information System (PIS) and especially for HUS Diagnostic Center HUSLAB for study sample logistics.

We thank all the study participants. 

We thank Juha Oksanen, Esa Ruokokoski, Elina Isosaari, Niina Ikonen, Dennis Ahlfors, Timo Koskenniemi, Nina Ekström, Pamela Österlund, Anu Haveri and Camilla Virta for their contributions related to data management and analyses.

This study was funded by the Finnish Institute for Health and Welfare.

\section{Data Accessibility}

The aggregated data which supports the findings of this study are available in the supplementary material of this article. Individual level data are not available due to data privacy. More detailed data related to the COVID-19 cases in Finland are available by formal request to the Finnish Social and Health Data Permit Authority Findata.

\section{Supplementary material}

The STAN code which implements the statistical methods described, and R code example which demonstrates how to apply the methods to the data described in the article, is available online \url{github.com/TuomoNieminen/covid19underreporting}. 
...
\input{tex/SUPPLEMENT_FIG}
\newpage

\section{Supplementary tables}

\input{tex/SUPPLEMENT_TAB}
\newpage
